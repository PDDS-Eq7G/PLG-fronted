...
const TanqueIntermedioMarker: React.FC<Props> = ({ x, y, cellSize, gridSizeY, opacity = 1, onClick }) => {
  ...
  return (
    <div
      ...
      role="img"
      aria-label='Tanque intermedio'
      title='Tanque intermedio'
    >
      <svg xmlns="http://www.w3.org/2000/svg" width={cellSize} height={cellSize} viewBox="0 0 22 22" fill="none">
...
export default TanqueIntermedioMarker;
